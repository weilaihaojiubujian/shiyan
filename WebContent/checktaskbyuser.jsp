...
<br>
 ...
 <br>
 <a href="checktaskbyuser.jsp?showPage=1">首页</a>
 <a href="checktaskbyuser.jsp?showPage=<%=showPage-1%>">上一页</a>
<% //根据pageCount的值显示每一页的数字并附加上相应的超链接
  for(int i=1;i<=pageCount;i++){
 %>
   <a href="checktaskbyuser.jsp?showPage=<%=i%>"><%=i%></a>
<% }
 %> 
 <a href="checktaskbyuser.jsp?showPage=<%=showPage+1%>">下一页</a>
 <a href="checktaskbyuser.jsp?showPage=<%=pageCount%>">末页</a>
