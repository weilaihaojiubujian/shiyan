...
<script src="jquery-3.3.1.min.js"></script>
    ...
    function call($value) {
    	...
    	if(document.getElementById("77").value==null)
    	{
    ...
    function init1($value) {
    	clear();
    	document.getElementById("77").value=$value;
    ...
    <link rel="stylesheet" type="text/css" href="css/comPleteTask.css">
</head>
<body onload="call(1)">
...
<div>
    ...
    <button class="button" type="button" onclick="p()" id="76" value="">尾页</button>
    <br>
